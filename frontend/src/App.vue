...
import { PhBookOpen, PhPencil, PhMoon, PhSun } from '@phosphor-icons/vue'
    ...
    <header class="sticky top-0 z-40 border-b border-stone-200 bg-white/80 backdrop-blur-lg dark:border-zinc-800 dark:bg-zinc-950/80">
      <div class="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        <RouterLink to="/" class="group flex items-center gap-3">
          <PhBookOpen size={28} weight="fill" class="text-indigo-600 transition-transform group-hover:scale-110" />
